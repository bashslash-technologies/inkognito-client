...
const VerifyRegisterComponent = ({navigation, route}) => {
  ...
  const HandleSubmit = async () => {
    if (!validate(code.trim(), 'Verification code is invalid', 'password'))
      return;
    try {
      setLoading(true);
        ...
        <StyledBottomContainer
          ...
          <View
            ...
            <Text
              ...
              Please the verify with the code we sent to your phone number (
